...
public class PlayerAnimationController : MonoBehaviour
{
    ...
    public IEnumerator PlayStartGameAnimation()
    {
        ...
        while (!animator.GetCurrentAnimatorStateInfo(0).IsName(PlayerAnimationConstants.StartGameAnimationState)) yield return null;

        while (animator.GetCurrentAnimatorStateInfo(0).IsName(PlayerAnimationConstants.StartGameAnimationState) &&
            animator.GetCurrentAnimatorStateInfo(0).normalizedTime < 1) yield return null;
    }
}
